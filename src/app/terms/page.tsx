        ...
        <div style={{ paddingTop: 'var(--header-height)' }}>
            ...
            <section className="section bg-surface">
                <div className="container" style={{ maxWidth: 850 }}>
                    ...
                    {/* Content */}
                    <div className="flex flex-col gap-12 text-secondary leading-relaxed">
                        <section id="acceptance">
                            <h2 className="text-title text-primary mb-6">1. Acceptance of Terms</h2>
                        ...
                        <section id="description">
                            <h2 className="text-title text-primary mb-6">2. Service Description</h2>
                        ...
                        <section id="accounts">
                            <h2 className="text-title text-primary mb-6">3. User Accounts</h2>
                        ...
                        <section id="use">
                            <h2 className="text-title text-primary mb-6">4. Acceptable Use</h2>
                        ...
                        <section id="accuracy">
                            <h2 className="text-title text-primary mb-6">5. Data Accuracy Disclaimer</h2>
                        ...
                        <section id="ip">
                            <h2 className="text-title text-primary mb-6">6. Intellectual Property</h2>
                        ...
                        <section id="links">
                            <h2 className="text-title text-primary mb-6">7. Third-Party Links</h2>
                        ...
                        <section id="liability">
                            <h2 className="text-title text-primary mb-6">8. Limitation of Liability</h2>
                        ...
                        <section id="indemnity">
                            <h2 className="text-title text-primary mb-6">9. Indemnification</h2>
                        ...
                        <section id="dispute">
                            <h2 className="text-title text-primary mb-6">10. Dispute Resolution</h2>
                        ...
                        <section id="changes">
                            <h2 className="text-title text-primary mb-6">11. Changes to Terms</h2>
                        ...
                        <section id="contact">
                            <h2 className="text-title text-primary mb-6">12. Contact Information</h2>
